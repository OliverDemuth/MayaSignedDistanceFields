...
```
The ligament lengths will be saved as .csv files in the results folder, named according to the respective Maya file in the Maya files folder. The ligament length calculations cannot directly be aborted unless the command prompt/terminal is closed, however, all progress will be lost.
